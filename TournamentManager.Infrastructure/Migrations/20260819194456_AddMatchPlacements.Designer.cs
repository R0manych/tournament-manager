...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.Encounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.Exchange", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.Fighter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.MatchPlacement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.TeamMember", b =>
                {
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.TournamentGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.Encounter", b =>
                {
                    b.HasOne("TournamentManager.Domain.Entities.Team", "Participant1")
                        .WithMany()
                        .HasForeignKey("Participant1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TournamentManager.Domain.Entities.Team", "Participant2")
                        .WithMany()
            ...
            modelBuilder.Entity("TournamentManager.Domain.Entities.Match", b =>
                {
                    b.HasOne("TournamentManager.Domain.Entities.Encounter", "Encounter")
                        .WithMany("Bouts")
